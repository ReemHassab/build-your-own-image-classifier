...
def training(model,epochs_number,criterion,optimizer,training_loader,validation_loader,testloaders,current_device):
 ...
 #---------------------------------------------------------            
'''def testClassifier(model, criterion, testloaders, current_device):
...
def main():
    ...
    with active_session():
        train_loss,valid_loss,valid_accuracy= training(model,epochs,criterion,optimizer,trainloaders,costloaders,testloaders,current_device)           
...
def saveCheckPoint(model):
    ...
    torch.save(check_point,'/home/workspace/ImageClassifier' )
